...
public class ConsultaListaProdutosFavoritosTest {
    ...
    public void setup() throws Exception {
        ...
        this.mockMvc.perform(post(url + "/produtos/a81e138c-a288-41fa-ab94-8f42d6add281")
                .header("Authorization", authorization)
                .contentType(MediaType.APPLICATION_JSON)
                .content(getBodyStatus()))
                .andExpect(status().isCreated());
    ...
    public void devoConsultarListaProdutosFavoritosEntaoRetornaHttp200() throws Exception {
        this.mockMvc.perform(MockMvcRequestBuilders.get(url + "/produtos?status=favorito")
                .header("Authorization", authorization)
                .contentType(MediaType.APPLICATION_JSON))
